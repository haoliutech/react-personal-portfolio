    ...
    return (
        <div className="hero bg-base-100 my-24">
            <div className="hero-content text-center">
                ...
                <p className="py-6">I am a junior full-stack developer based in Adelaide,
                    <br/>graduated with Master of CS from Uni Adelaide,
                    <br/>actively looking for a full-time position in Australia.</p>
                <button className="btn btn-accent" onClick={()=>openInNewTab("https://www.linkedin.com/in/haoliutech/")}>Contact Me</button>
                </div>
            </div>
        </div>
    )
