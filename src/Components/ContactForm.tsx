...
export default function ContactForm() {
  ...
  return (
    <>
      <h3 id="contactform" className="text-3xl font-bold text-center mb-4">Contact Me!</h3>
      <div className="m-auto px-8 max-w-screen-sm bg-base-100">
        {!isSubmitSuccessful && (
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <button
              type="submit"
              className="w-full py-4 transition-colors font-bold bg-accent rounded-md hover:bg-indigo-500 focus:outline-none focus:ring-offset-2 focus:ring focus:ring-indigo-200 px-7 umami--click--contact-submit">
              {isSubmitting ? (
                <svg
